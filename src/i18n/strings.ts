...
export const ko = {
  ...
  timesSuffix: '회',
  // 악보 빌더 (PR-1) — ko only
  builderUntitled: '무제 악보',
  builderClear: '비우기',
  builderSave: '저장',
  builderPlay: '▶ 재생',
  builderTitlePlaceholder: '악보 제목',
  builderAddMeasure: '+ 마디 추가',
  ...
  builderCellClear: '클릭해서 비우기',
  builderCellPlace: '클릭해서 코드 넣기',
  builderArm: '고르기',
  builderArmed: '✓ 선택됨',
  builderPaletteTitle: '담은 코드 · 클릭해서 선택',
  builderPaletteEmpty: '아직 담은 코드가 없어요. ',
  builderPaletteEmptyLink: '코드 사전',
  builderPaletteEmptyTail: ' 에서 「담기」를 눌러보세요.',
  builderSavedTitle: (n: number) => '저장된 악보 ' + n,
  builderLoad: '불러오기',
  builderDelete: '삭제',
  builderNeedChord: '코드를 먼저 넣어주세요',
  builderSaved: '악보를 저장했어요',
  builderLoaded: (title: string) => title + ' 불러옴',
